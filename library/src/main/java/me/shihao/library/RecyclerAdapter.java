...
/**
 * Created by shihao <1406504841@qq.com> on 2017/2/13.15:48
 */
...
public abstract class RecyclerAdapter<T, V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<V> {
    ...
    public void removeElements(List<T> elements) {
        if (data != null && elements != null && elements.size() > 0 && data.size() >= elements.size()) {
    ...
    public void setRecItemClick(RecyclerItemCallback<T, V> recItemClick) {
